...
class TestMine:
    ...
    def test_no_build_on_mountain(self):
        game.player.y, game.player.x = (20, 20)
        game.mines = []
        game.build_mine()
        assert len(game.mines) == 0

    def test_no_build_far_from_mountain(self):
        game.player.y, game.player.x = (20, 18)
        game.mines = []
        game.build_mine()
        assert len(game.mines) == 0

    def test_no_build_far_from_base(self):
    ...
    def test_no_build_on_existing_building(self):
        game.player.y, game.player.x = (20, 19)
        game.mines = [
            Mine(20, 19),
        ]
    ...
    def test_no_build_without_gold(self):
        game.base.gold = 0
        game.player.y, game.player.x = (20, 19)
        game.mines = []
        game.build_mine()
    ...
    def test_no_sell_from_different_location(self):
...
class TestLantern:
    def test_build_lantern_ok(self):
        game.base.gold = 100
        game.player.y, game.player.x = (20, 19)
        game.linterns = []
        game.build_lantern()
    ...
    def test_no_build_lantern_without_gold(self):
        game.base.gold = 0
        game.player.y, game.player.x = (20, 19)
        game.linterns = []
        game.build_lantern()
...
class TestBombs:
    def test_throw_bomb(self):
        game.player.bombs = 1
        game.throw_bomb()
        assert game.player.bombs == 0

    def test_no_throw_bomb_empty_inventory(self):
        game.player.bombs = 0
        game.throw_bomb()
        assert game.player.bombs == 0
...
class TestBuildings:
    ...
    def test_no_upgrade_without_gold(self):
        game.player.y, game.player.x = (20, 19)
